        ...
        <ul className='grid grid-cols-1 gap-4 text-gray-500 font-extrabold lg:grid-cols-2'>
          <li className='bg-[#fcfaf2]/30 h-[480px] w-[100%] p-4 rounded-lg '>
            ...
            <div className='grid grid-cols-3 lg:grid-cols-1'>
              <div className='mx-auto my-4 w-[90%] bg-white/50 h-[240px] rounded-lg text-center py-4 md:col-span-2'>img</div>
              <ul className='grid gap-2 m-6'>
                <li>React</li>
          ...
          <li className='bg-[#fcfaf2]/30 h-[480px] w-[100%] p-4 rounded-lg '>
            ...
            <div className='grid grid-cols-2 lg:grid-cols-1'>
              <div className='mx-auto my-4 w-[90%] bg-white/50 h-[240px] rounded-lg text-center py-4'>img</div>
              <ul className='grid gap-2 m-6'>
                <li>React</li>
                <li>Styled-components</li>
                <li>Framer-motion</li>
